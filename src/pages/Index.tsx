...
const Index = () => {
  ...
  const testimonials = [
    { title: "ИСЧЕЗЛА ТРЕВОГА", text: "После MUSCIMOL OIL я стала засыпать за 10 минут и наконец-то просыпаться отдохнувшей. Исчезла фоновая тревога, которая годами меня изматывала." },
    { title: "Стал сдержанным и спокойным", text: "Проснулся выспавшимся, хотя время сна не изменилось. Ушел мозговой шум, стал более сдержанным и спокойным. Пропил 3 курса." },
    { title: "Вышла из ужасного состояния", text: "Мне 63: тряслись руки, не было сил стоять в душе. Через 10 дней мозг прояснился, дрожь прошла. Сегодня я вернула свою активность." },
    { title: "Бросил вредные привычки", text: "Забыл запах алкоголя, сигарет больше нет. Появилась энергия — снова делаю зарядку, турник, мне 51 год. Нервы пришли в спокойствие." },
    { title: "Изменения, которых ждали много лет", text: "У моего ребенка-инвалида появился диалог, эмоциональная выносливость, ум стал более пытливым. В школе заметили, что он стал более усидчивым." },
    { title: "Перестал болеть", text: "Этой осенью, когда все вокруг болели, меня пронесло. Иммуно реально укрепил иммунитет, поборол усталость. Безумно доволен." }
  ];

  const objections = [
    { icon: "Shield", title: "Боюсь побочек и привыкания", text: "Наши формулы — мягкие и нестимулирующие. Они восстанавливают ЕСТЕСТВЕННЫЕ процессы организма. Идеально подходят для чувствительных людей." },
    { icon: "Sparkles", title: "Уже пробовал БАДы — не помогло", text: "В отличие от разрозненных добавок, это — система. Экстракты + режим + знания + поддержка. Эффект вы почувствуете уже в первую неделю." },
    { icon: "BookOpen", title: "Сложно разобраться", text: "Вы получаете готовый режим приема и ежедневные напоминания. Всё, что от вас требуется — следовать простым шагам." },
    { icon: "TrendingUp", title: "Это дорого", text: "Комплект экстрактов отдельно стоит 60 000 ₽. Марафон — это ваш шанс получить систему в 2 раза дешевле. Это инвестиция в вашу энергию." }
  ];
      ...
      <section className="py-12 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-700 mb-8 text-center">
            Ты уже пробовал «больше спать», «нормально питаться» и «пить добавки». 
            Но это не сработало, потому что проблема глубже:
          </p>
          <div className="space-y-6">
            {[
              { icon: "Brain", title: "Нервная система истощена", text: "хроническим стрессом. Отсюда — тревога, которая не отпускает, и сон, который не восстанавливает." },
              { icon: "Lightbulb", title: "Мозг перегружен", text: "и не может очищаться. Отсюда — «туман», прокрастинация и ощущение, что ты работаешь на 20% от своих возможностей." },
              { icon: "Activity", title: "Тело работает на износ", text: "не успевая восстанавливаться. Отсюда — усталость с самого утра и отсутствие энергии." }
            ].map((item, i) => (
          ...
          <Card className="p-8 bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-primary">
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Структура:</strong> 1-й месяц — восстановление тела, 2-й месяц — перезагрузка мозга</span>
              </li>
              <li className="flex items-start gap-2">
                <Icon name="Check" className="text-accent shrink-0 mt-1" size={20} />
              ...
              <li className="flex items-start gap-2">
                <Icon name="Check" className="text-accent shrink-0 mt-1" size={20} />
                <span><strong>Поддержка кураторов 24/7</strong> — ответы на вопросы в режиме реального времени</span>
              </li>
            </ul>
          </Card>
      ...
      <section id="booking" className="py-16 px-6 bg-gradient-to-br from-primary via-accent to-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-8 text-lg opacity-90">
            Сделай себе главный подарок в этом году — верни себе себя.
          </p>
